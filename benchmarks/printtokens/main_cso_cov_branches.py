...
import cso_ga_tcp_claude_copy_good_tbs
...
best_test_cso_ga, all_tests,best_test_cso_ga_fitness = cso_ga_tcp_claude_copy_good_tbs.hybrid_cuckoo_search_ga(test_cases, population_size,no_tcp, generations, mutation_rate)
